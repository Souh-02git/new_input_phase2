...
class SimulationEngine:
    ...
    def simulate_scenario(self, recommendations: Sequence[Union[Recommendation, str]]) -> ScenarioResult:
        ...
        if not normalized_recommendations:
            return self._build_scenario_result([], self._recalculate_clone(self.project_state.model_copy(deep=True)))
        ...
        scenario = self._build_scenario_result(normalized_recommendations, simulated)
    ...
    def _build_scenario_result(self, recommendations: Sequence[Recommendation], simulated: Dict[str, Any]) -> ScenarioResult:
